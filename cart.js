...
/* Generating Cart Page with product cards composed of */
...
/* increasing selected product item quantity by 1 */
...
/* calculate total amount of the selected Products */
...
let TotalAmount = () => {
  if (basket.length !== 0) {
    ...
    <h2 class="total">Total : Ghc ${amount}</h2>
...
/* clearing cart and removing everything from local storage */
